...
window.__CR_LANGS__ = {
  "Mise à jour requise": {"en": "Update required", "it": "Aggiornamento richiesto", "es": "Actualización necesaria", "de": "Update erforderlich", "pt": "Atualização necessária", "nl": "Update vereist", "pl": "Wymagana aktualizacja"},
  "Une nouvelle version est disponible. Merci de mettre à jour 5 Rois pour continuer à jouer.": {"en": "A new version is available. Please update 5 Rois to keep playing.", "it": "È disponibile una nuova versione. Aggiorna 5 Rois per continuare a giocare.", "es": "Hay una nueva versión disponible. Actualiza 5 Rois para seguir jugando.", "de": "Eine neue Version ist verfügbar. Bitte aktualisiere 5 Rois, um weiterzuspielen.", "pt": "Está disponível uma nova versão. Atualiza 5 Rois para continuares a jogar.", "nl": "Er is een nieuwe versie beschikbaar. Werk 5 Rois bij om te blijven spelen.", "pl": "Dostępna jest nowa wersja. Zaktualizuj 5 Rois, aby grać dalej."},
  "Mettre à jour": {"en": "Update", "it": "Aggiorna", "es": "Actualizar", "de": "Aktualisieren", "pt": "Atualizar", "nl": "Bijwerken", "pl": "Zaktualizuj"},
