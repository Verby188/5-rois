...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        webView = WebView(this).apply { layoutParams = FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.MATCH_PARENT) }
        setContentView(webView)
        webView.settings.apply { javaScriptEnabled = true; domStorageEnabled = true; allowFileAccessFromFileURLs = true; allowUniversalAccessFromFileURLs = true; mediaPlaybackRequiresUserGesture = false; cacheMode = WebSettings.LOAD_DEFAULT; setSupportZoom(false); useWideViewPort = true; loadWithOverviewMode = true }
